(() => {
  var Z = Object.create,
    ...
    fe = ie((s, n) => {
      (function(p, d, M) {
        ...
        function U(e, t, a) {
          return a || (a = J()[e] ? "keydown" : "keypress"),
        ...
        function v(e) {
          ...
          function N(r, o, l, i, u) {
            ...
            f = I(r, l), t._callbacks[f.key] = t._callbacks[f.key] || [],
              j(f.key, f.modifiers, {
                type: f.action
              }, i, r, u),
  ...
  var le = s => {
    s.directive("mousetrap", (n, {
      ...
      p.includes("global") && (p = p.filter(y => y !== "global"), R.default.bindGlobal(p, y => {
        y.preventDefault(), h();
      }));
      R.default.bind(p, y => {
        y.preventDefault(), h();
  ...
  document.addEventListener("alpine:init", () => {
    ...
    window.Alpine.effect(() => {
      if (window.Alpine.store("theme") === "dark") {
